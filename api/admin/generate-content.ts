...
The JSON response MUST strictly follow this structure:
{
  ...
  "authorRole": "Senior Document Workflow Architect",
  ...
  "sections": [
    {
      ...
      "paragraphs": [
        ...
        "In-depth paragraph 2 explaining core concepts..."
      ],
      "listItems": [
        "Key point or benefit 1...",
        "Key point or benefit 2..."
      ],
      "callout": {
        "type": "key-takeaway",
        "title": "Core Takeaway",
    ...
    ... (provide 6 to 8 exhaustive sections totaling over 2000 words. Must include an Introduction, Benefits, Step-by-Step Guide with numbered steps, Common Mistakes, Best Practices, Why Choose SmartPDF AI, and Conclusion)
  ]
}
...
3. Provide step-by-step guides using the \`steps\` array inside the relevant section: \`steps: [{ "number": 1, "title": "Step Title", "description": "Step Description" }]\`.
4. The output MUST be valid JSON and ONLY JSON.`;
